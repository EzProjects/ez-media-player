 ...
 */
public class EzVideoPlayerBehaviorView extends FrameLayout implements GestureDetector.OnGestureListener {
    ...
    public EzVideoPlayerBehaviorView(Context context) {
        super(context);
        init();
    }

    public EzVideoPlayerBehaviorView(Context context, AttributeSet attrs) {
        super(context, attrs);
        init();
    }

    public EzVideoPlayerBehaviorView(Context context, AttributeSet attrs, int defStyleAttr) {
